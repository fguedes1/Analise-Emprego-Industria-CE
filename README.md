O projeto constituiu em uma análise de dados do mercado de trabalho formal acerca da indústria calçadista do estado do Ceará. Mais especificamente, o projeto consistia na elaboração de um relatório para responder as seguintes perguntas:
...
O script criado para fornecer as análises solicitadas foi salvo em @script.R
